    ...
    <main className="min-h-screen bg-black">
      <AnimatePresence>
        {showWelcome && (
          ...
          >
            <div className="relative bg-black rounded-2xl shadow-2xl overflow-hidden max-w-lg w-full">
              <button
                className="absolute top-3 right-3 z-10 bg-white/20 hover:bg-white/40 text-white rounded-full p-2 transition-all"
                onClick={() => setShowWelcome(false)}
                aria-label="Fermer la vidéo de bienvenue"
              >
                <span className="text-2xl font-bold">×</span>
              </button>
              <video
                src="/login/welcome.mp4"
                autoPlay
                loop
                muted
                playsInline
      ...
      <div className={showWelcome ? "pointer-events-none filter blur-sm select-none" : ""}>
